...
package com.example.assign2.Util;
...
public class JwtUtil {
    ...
    // Typically these parameters should be stored application.yaml file or
    ...
    // (e.g. in a database). This allows the server to manage and revoke tokens as
    // needed.
